...
class TestBesselIvSeries(chex.TestCase):
    ...
    def test_iv_series_against_scipy(self, v, x):
    ...
    def test_iv_series_vectorized(self):
    ...
    def test_iv_series_negative_order(self):
    ...
    def test_iv_series_output_shape(self):
...
class TestBesselK0Series(chex.TestCase):
    ...
    def test_k0_series_against_scipy(self, x, expected):
    ...
    def test_k0_series_vectorized(self):
    ...
    def test_k0_series_output_shape(self):
        """Output shape matches input shape."""
        x_arr = jnp.array([[0.5, 1.0], [1.5, 2.0]], dtype=jnp.float64)
        result = _bessel_k0_series(x_arr, x_arr.dtype)
        chex.assert_shape(result, (2, 2))

    def test_k0_series_positive_values(self):
...
class TestBesselKnRecurrence(chex.TestCase, parameterized.TestCase):
    ...
    def test_kn_recurrence_n0(self):
        """n=0 returns K_0."""
    ...
    def test_kn_recurrence_n1(self):
        """n=1 returns K_1."""
        x = jnp.array([1.0], dtype=jnp.float64)
        k0 = jnp.array([0.42102443824070834], dtype=jnp.float64)
        k1 = jnp.array([0.6019072301972346], dtype=jnp.float64)
    ...
    def test_kn_recurrence_higher_orders(self, n, x, expected):
    ...
    def test_kn_recurrence_vectorized(self):
...
class TestBesselKvSmallNonInteger(chex.TestCase, parameterized.TestCase):
    ...
    def test_kv_small_non_integer(self, v, x, expected):
    ...
    def test_kv_small_non_integer_vectorized(self):
...
class TestBesselKvSmallInteger(chex.TestCase, parameterized.TestCase):
    ...
    def test_kv_small_integer_v0(self, v, x, expected):
    ...
    def test_kv_small_integer_positive(self):
...
class TestBesselKvLarge(chex.TestCase, parameterized.TestCase):
    ...
    def test_kv_large_decays_exponentially(self):
...
class TestBesselKHalf(chex.TestCase, parameterized.TestCase):
    ...
    def test_k_half_vectorized(self):
...
class TestBesselKv(chex.TestCase, parameterized.TestCase):
    ...
    def test_bessel_kv_integer_orders(self, v, x, expected):
    ...
    def test_bessel_kv_half_order(self, v, x, expected):
    ...
    def test_bessel_kv_non_integer_orders(self, v, x, expected):
    ...
    @chex.variants(with_jit=True, without_jit=True)
    def test_bessel_kv_vectorized(self):
        """Vectorized x input works."""
        x_arr = jnp.array([0.5, 1.0, 2.0, 5.0], dtype=jnp.float64)
    ...
    @chex.variants(with_jit=True, without_jit=True)
    def test_bessel_kv_2d_input(self):
    ...
    @chex.variants(with_jit=True, without_jit=True)
    def test_bessel_kv_positive_values(self):
    ...
    @chex.variants(with_jit=True, without_jit=True)
    def test_bessel_kv_monotonic_decay(self):
    ...
    @chex.variants(with_jit=True, without_jit=True)
    def test_bessel_kv_order_relation(self):
    ...
    def test_bessel_kv_jit_compilation(self):
    ...
    def test_bessel_kv_jit_works(self):
...
class TestBesselKvEdgeCases(chex.TestCase):
    ...
    def test_bessel_kv_small_x_boundary(self):
    ...
    def test_bessel_kv_large_x(self):
    ...
    def test_bessel_kv_higher_integer_order(self):
