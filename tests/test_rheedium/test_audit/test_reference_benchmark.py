...
@pytest.mark.xfail(
    reason=(
        "Reference fixtures were generated by the pre-remediation CTR "
        "model; the unified truncation-rod physics (WP5.1/WP5.2) shifts "
        "intensities so the self-consistency NCC is no longer exactly 1. "
        "Regenerate fixtures in Phase 12 (WP8.11)."
    ),
    strict=False,
)
