...
# %%
_selected_data = (
    mgo_phi_sweep_data if mgo_sweep_kind == "phi" else mgo_roughness_sweep_data
)
...
_ax.imshow(
    np.asarray(mgo_sweep_image_bank[mgo_sweep_index]),
...
# %%
display(mgo_sweep_value)
display(Markdown(mgo_sweep_summary))
display(mgo_sweep_fig)
