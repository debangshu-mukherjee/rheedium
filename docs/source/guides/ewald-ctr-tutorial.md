...
![Ewald Sphere 2D](figures/ewald_sphere_2d.svg)
...
![Roughness Damping](figures/roughness_damping.svg)
...
![Ewald Sphere 3D](figures/ewald_sphere_3d_perspective.svg)
...
- [`tools/simul_utils.py`](../../../src/rheedium/tools/simul_utils.py) — Wavelength and wavevector utilities
