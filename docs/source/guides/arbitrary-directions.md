...
![Grazing Incidence Geometry](figures/grazing_incidence_geometry.svg)
...
- [`tools/simul_utils.py`](../../../src/rheedium/tools/simul_utils.py) - `incident_wavevector` calculation
