...
- [`simul/form_factors.py`](https://github.com/debangshu-mukherjee/rheedium/blob/main/src/rheedium/simul/form_factors.py) - Form factor and Debye-Waller implementations
- [`inout/luggage/Kirkland_Potentials.csv`](https://github.com/debangshu-mukherjee/rheedium/blob/main/src/rheedium/inout/luggage/Kirkland_Potentials.csv) - Kirkland coefficient table
